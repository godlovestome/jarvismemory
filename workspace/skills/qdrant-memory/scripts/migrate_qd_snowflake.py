#!/usr/bin/env python3
"""
Migrate Qdrant_Documents to 1024D vectors (mxbai-embed-large) - BATCH VERSION
"""
...
def get_embeddings_batch(texts):
    """Generate embeddings in batch using mxbai-embed-large"""
    # Truncate each text
...
# Process in batches
print(f"Re-embedding with mxbai-embed-large (batch={BATCH_SIZE})...\n")
success = 0
failed = 0
